...
from gmbp_common.utils.datetime_utils import infer_start_dateid_end_dateid
        ...
        for form in tqdm(self.form_list):
            ...
            with open(form, 'r') as json_file:
                ...
                if not table.empty:
                    ...
                    table_sorted['openPrice'] = table_sorted['open']
                    table_sorted['closePrice'] = table_sorted['close']
                    table_sorted = table_sorted.drop(columns=['date', 'open', 'close'])
